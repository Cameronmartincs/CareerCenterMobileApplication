...
public class bowAndArrow : MonoBehaviour {
	...
	public void showHighscore() {
		...
		{
			Debug.Log(score + " " + PlayerPrefs.GetString("ScoreSaved") + " " + PlayerPrefs.GetString("PCID"));
			string constr = "Data Source = 127.0.0.1,1433; Initial Catalog = 480Project; Uid=garcia; Pwd=g;";
			SqlConnection con = new SqlConnection(constr);
			con.Open();
			SqlCommand com = new SqlCommand(@"Update SeniorGameScore SET BowAndArrow = @Score Where PCID = @PCID", con);
			com.Parameters.Add("@Score", SqlDbType.Int, 100);
			com.Parameters["@Score"].Value = score;
			com.Parameters.Add("@PCID", SqlDbType.NVarChar, 100);
			com.Parameters["@PCID"].Value = PlayerPrefs.GetString ("PCID");
			com.ExecuteNonQuery ();
			con.Close ();
